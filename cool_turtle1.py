...
speed(1)  # sets the speed of drawing to 0, which is the fastest
pencolor('red')  # sets the color of the pen/lines to white
...
while x < 2:  # while the value of x is lesser than 120,
